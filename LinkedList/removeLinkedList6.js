//Eliminar un nodo de la lista enlazada en la posición especificada por el índice
class Node {
    constructor(value) {
        this.value = value
        this.next = null
...
console.log(list.removeFrom(8))//Resultado sera null porque no hay 8 elemntos
console.log(list.removeFrom(0))//Eliminar node en la posición 0

list.print();//Imprimir la nueva lista
